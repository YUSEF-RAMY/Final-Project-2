...
interface Step1MetricProps {
  ...
  imageReady: boolean;
  // تم إزالة previewImg من هنا لأنه غير مستخدم
...
const Step1Metric: React.FC<Step1MetricProps> = ({ 
  ...
  const capture = useCallback(() => {
    ...
    if (imageSrc) {
      ...
      setMode('upload'); // نعود لوضع الـ InBody لإظهار علامة الصح
    }
  }, [webcamRef, previewImage, setMode]);

  // دالة التعامل مع خطأ الكاميرا
  ...
  return (
    <div className={styles['step-card']}>
      ...
      <div className={styles['card-body']}>
        ...
        {/* وضع الرفع (InBody) - يظهر علامة صح فقط عند الجاهزية */}
        {mode === 'upload' && (
          <div 
        ...
        {/* وضع الكاميرا - تصميم طولي فلكسبل */}
        {mode === 'camera' && (
          <div style={{ 
            position: 'relative', 
            width: '100%', 
