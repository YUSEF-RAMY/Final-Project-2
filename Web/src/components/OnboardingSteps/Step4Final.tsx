...
// تعريف الـ Types الخاصة بالـ Props لخطوة التفاصيل الطبية
...
const Step4Final: React.FC<Step4FinalProps> = ({ medical, setMedical }) => (
  // استدعاء كلاس الـ card من الموديول
  <div className={styles['step-card']}>
    <h3 style={{ margin: 0 }}>Final Details</h3>
    <div className={styles['card-body']}>
      <input 
        type="text" 
        // إذا كان هناك تنسيق خاص للـ input في الـ CSS تأكدي من إضافة className={styles.inputField} مثلاً
